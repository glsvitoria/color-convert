		...
		<div className="md:w-picker sm:w-picker-sm w-full h-picker bg-white items-center justify-center p-4 rounded-2xl flex flex-col lg:gap-6 md:gap-4 gap-2 shadow-xl">
								...
								onChange: (event) => {
									...
									if (
										...
										if (valueWithoutHash.length === 3) {
											...
											valueWithoutHash.length === 6
										) {
											handleChangeColor({
												red: convert.hexToDecimalWithString(
													valueWithoutHash.substring(
														0,
														2
													)
												),
			...
			<div className="flex flex-col lg:gap-6 md:gap-4 gap-2 w-full">
				<Indicator.Color
					...
					value={color.red}
					onChange={(value) =>
						handleChangeColor({ ...color, red: value })
					}
				...
				<Indicator.Color
					...
					value={color.green}
					onChange={(value) =>
						handleChangeColor({ ...color, green: value })
					}
					selectedValue={selectValue}
				/>
				...
				<Indicator.Color
					...
					value={color.blue}
					onChange={(value) =>
						handleChangeColor({ ...color, blue: value })
					}
					selectedValue={selectValue}
				/>
